...
// Criar query
$sql ="DELETE FROM Playlist_has_Conteudo WHERE Conteudo_ID = :ID";
...
// Executar query
if ($stmt->execute()) {
    $result = '<div class="alert alert-success">Conteúdo desassociada da Playlist.</div>';
    // Criar query
    ...
    // Executar query
    if ($stmt->execute()) {
        $result .= '<div class="alert alert-success">Conteúdo removido com sucesso.</div>';


    }else{
        $result .= '<div class="alert alert-danger">Erro ao remover Conteúdo.</div>';
    }


}else{
    $result = '<div class="alert alert-danger">Erro ao desassociar Conteúdo.</div>';
}
