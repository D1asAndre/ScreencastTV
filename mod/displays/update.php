...
<form action="?m=<?= $module ?>&a=update&id=<?= $id ?>" role="form" method="post">
    ...
    <div class="oie">
        ...
        <input name="macaddress" id="macaddress" type="text" value="<?= $reg['macaddress'] ?>" class="form-control">
    </div>
    <div class="form-group">
        <label for="token">Token</label>
        <input name="token" id="token" type="text" value="<?= $reg['token'] ?>" class="form-control">
    </div>
    <div class="form-group">
        <label for="image">Image</label>
        <input name="image" id="image" type="text" value="<?= $reg['image'] ?>" class="form-control">
    </div>
